...
public class CreateUserCommandHandler(UserManager<UserEntity> userManager) : IRequestHandler<CreateUserCommand, UserDto>
{
    public async Task<UserDto> Handle(CreateUserCommand request, CancellationToken cancellationToken)
    {
        ...
        var user = new UserEntity { UserName = request.User.UserName, Email = request.User.Email };
